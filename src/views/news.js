...
const News = (props) => {
  return (
    <div className="news-container">
      ...
      <NavbarInteractive rootClassName="navbar-interactive-root-class-name27"></NavbarInteractive>
    </div>
  )
}
