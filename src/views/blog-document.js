...
import './blog-document.css'

const BlogDocument = (props) => {
  return (
    <div className="blog-document-container">
      <Helmet>
        <title>BlogDocument - Serch - Service made easy</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="BlogDocument - Serch - Service made easy"
        />
        <meta
      ...
      <NavbarInteractive rootClassName="navbar-interactive-root-class-name26"></NavbarInteractive>
    </div>
  )
}
