...
const Blog = (props) => {
  return (
    <div className="blog-container">
      ...
      <NavbarInteractive rootClassName="navbar-interactive-root-class-name25"></NavbarInteractive>
    </div>
  )
}
