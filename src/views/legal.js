...
const Legal = (props) => {
  return (
    <div className="legal-container">
      <Helmet>
        <title>Legal - Serch - Service made easy</title>
        <meta
          name="description"
          content="A requestSharing and provideSharing platform connecting users to artisans of these categories:\n1. Mechanics\n2. Plumbers\n3. Electricians\n4. Carpenters"
        />
        <meta property="og:title" content="Legal - Serch - Service made easy" />
        <meta
      ...
      <NavbarInteractive rootClassName="navbar-interactive-root-class-name23"></NavbarInteractive>
    </div>
  )
}
